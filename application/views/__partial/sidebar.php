                    ...
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Master </span></a>
                            <ul aria-expanded="false" class="collapse  first-level" style="padding-left: 20px;">
                                <li class="sidebar-item"><a href="<?php echo base_url('index.php/admin/C_MasterBarang') ?>" class="sidebar-link"><i class="mdi mdi-receipt"></i><span class="hide-menu"> Barang </span></a></li>
                                ...
                                <li class="sidebar-item"><a href="<?php echo base_url('index.php/dashboard') ?>" class="sidebar-link"><i class="mdi mdi-receipt"></i><span class="hide-menu"> Customer </span></a></li>
                                <li class="sidebar-item"><a href="<?php echo base_url('index.php/dashboard') ?>" class="sidebar-link"><i class="mdi mdi-receipt"></i><span class="hide-menu"> Jasa Kirim </span></a></li>
                                <li class="sidebar-item"><a href="<?php echo base_url('index.php/dashboard') ?>" class="sidebar-link"><i class="mdi mdi-receipt"></i><span class="hide-menu"> Bank </span></a></li>
