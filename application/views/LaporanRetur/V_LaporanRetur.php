                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Laporan Data Retur</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-header">
                                            <h6 class="card-title">Cetak Laporan Data Retur</h6>
                                        </div>
                                        <div class="card-body">
                                            <form action="<?php echo base_url('index.php/admin/C_LaporanRetur/cetak') ?>" method="post">
