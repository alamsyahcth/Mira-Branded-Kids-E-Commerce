                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="id_banner" id="id_banner" class="form-control" readonly="" value="<?php echo $k->id_banner; ?>">
                                                                            </div>

                                                                            <div class="form-group">
                                                                                <label for="gambar_banner" class="control-label">Gambar <p class="text-danger">Ukuran 10,84 x 4,24</p></label>
                                                                                <input type="file" name="gambar_banner" id="gambar_banner" class="form-control" placeholder="Gambar Banner" value="<?php echo $k->gambar_banner; ?>">
                                                                                <input type="hidden" name="old_pic" value="<?php echo $k->gambar_banner ?>"
                                                                                <img src="<?php echo base_url('upload/banner/'.$k->gambar_banner) ?>" width="30%">
                                                                            </div>

                                                                            <div class="form-group">
                                                                                <label for="nm_banner" class="control-label">Judul Banner</label>
                                                                                <input type="text" name="judul_banner" id="judul_banner" class="form-control <?php echo form_error('judul_banner') ? 'is-invalid' : '' ?>" value="<?php echo $k->judul_banner; ?>" placeholder="Judul Banner">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <textarea type="textarea" name="deskripsi_banner" id="deskripsi_banner" class="form-control <?php echo form_error('deskripsi_banner') ? 'is-invalid' : '' ?>" placeholder="Deskripsi Banner" ><?php echo $k->deskripsi_banner; ?></textarea>
                                                                                <div class="invalid-feedback">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select name="status_banner" class="form-control <?php echo form_error('status_banner') ? 'is-invalid' : '' ?>">
                                                                                    <option <?php if($k->status_banner=='1')  {echo 'selected';} ?> value="1">Aktif</option>
                                                                                    <option <?php if($k->status_banner=='2')  {echo 'selected';} ?> value="2">Tidak Aktif</option>
                                                                                </select>
                                                                                <div class="invalid-feedback">
                                                     ...
                                                     <table id="dataTableConfig" class="table table-hover table-stripted table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="30%" style="vertical-align:center; tect-align:center;">
