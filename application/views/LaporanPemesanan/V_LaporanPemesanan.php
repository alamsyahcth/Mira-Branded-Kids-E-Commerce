            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Laporan Data Pemesanan</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">Laporan</li>
                                    <li class="breadcrumb-item active" aria-current="page">Laporan Data Pemesanan</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-header">
                                            <h6 class="card-title">Cetak Laporan Data Pemesanan</h6>
                                        </div>
                                        <div class="card-body">
                                            <form action="<?php echo base_url('index.php/admin/C_LaporanPemesanan/cetak') ?>" method="post">
