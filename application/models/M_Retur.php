...
class M_Retur extends CI_Model {
    ...
    public function getOrder($id) {
        $sql ="SELECT a.id_order, id_resi, tanggal_order, tanggal_resi, DATE_ADD(tanggal_resi, INTERVAL 3 DAY) AS tanggal_akhir
                FROM detil_orders a, orders b, resi c, customer d
                WHERE a.id_order=b.id_order AND b.id_order=c.id_order AND b.id_customer=d.id_customer AND b.id_customer='$id'
                GROUP BY a.id_order";
